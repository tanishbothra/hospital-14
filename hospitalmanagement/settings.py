...
ALLOWED_HOSTS = ['hospital13.herokuapp.com','127.0.0.1']
...
EMAIL_RECEIVING_USER = ['championships902@gmail.com'] # email on which you will receive messages sent from website
